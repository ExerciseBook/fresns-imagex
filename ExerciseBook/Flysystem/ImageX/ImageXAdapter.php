...
use App\Plugins\ImageX\ExerciseBook\Flysystem\ImageX\Exception\FileNotFoundException;
use App\Plugins\ImageX\ExerciseBook\Flysystem\ImageX\Exception\FilesystemException;
use App\Plugins\ImageX\Volc\Service\ImageX;
use Exception;
...
class ImageXAdapter
{
     ...
     * @return string
     */
    public function getImageUploadFiles($fNamePrefix = null, $offset = 0, $limit = 1, $marker = 0)
    {
        $applyParams = [];
     ...
     * @return string
     */
    public function getImageUploadFile($storeUri = null)
    {
        $applyParams = [];
    ...
    public function write($path, $contents, Config $config)
    {
        ...
        $request = $tosClient->createRequest('PUT',
